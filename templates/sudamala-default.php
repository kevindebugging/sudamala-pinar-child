<?php 
/**
 * sudamala-default.php
 * Sudamala Default Template
 * Template Name: Sudamala Default Template
 */

get_header();

echo '<div id="home-top-section">';
echo do_shortcode('[sudamala-page-slider image="'. get_field('slider_images').'" class="'. get_field('slider_class').'"]' );
