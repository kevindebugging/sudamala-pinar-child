<?php
/**
 *	sudamala-contact-alt.php
 * 	Sudamala Contact Alternative template
 *  Template Name: Sudamala Contact Alternative
 */
global $pinar_opt;
get_header();
?>
		...
		<div class="contact-info-inner clearfix">
			<div class="contact-info-box col-md-4">
				<div class="inner-content">
					<i class="fa fa-envelope-o"></i><div class="info"><a href="mailto:<?php echo esc_html( $pinar_opt['opt-hotel-email'] ); ?>"><?php echo esc_html( $pinar_opt['opt-hotel-email'] ); ?></a></div>
				</div>
			</div>
			<div class="contact-info-box col-md-4">
				<div class="inner-content">
